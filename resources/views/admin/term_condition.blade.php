                ...
                <div class="card">
                    <div class="card-body">
                        <table id="complex-header" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php $i=1;
                                    foreach($term_condition as $tc) { ?>
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $tc->heading; ?></td>
                                            <td><?php echo $tc->description; ?></td>
                                            <td>
                                                <a class="btn btn-success btn-sm" href="javascript:void();" data-toggle="modal" data-target="#myeditModal<?php echo $tc->id; ?>" ><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-danger btn-sm" onclick="alert('Are You Sure To Delete This?')" href="<?php echo route('delete_term_condition',['id'=>''.$tc->id.'']) ?>" ><i class="fa fa-trash"></i></a>
                                            </td>                                                                         
                                        </tr>
                                        <div class="modal" id="myeditModal<?php echo $tc->id; ?>">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <!-- Modal Header -->
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Update Terms & Conditions</h4>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group bmd-form-group">
                                                                        ...
                                                                        <input type="hidden" class="form-control" name="update" value="<?php echo $tc->id; ?>" autocomplete="off" required="" >
                                                                        <input type="text" class="form-control" name="heading" value="<?php echo $tc->heading; ?>" autocomplete="off" required="" >
                                                                        @if ($errors->has('heading'))
                                                                        <strong class="text-danger">{{ $errors->first('heading') }}</strong>                                   
                                                                        @endif
                                                                    </div>                      
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group bmd-form-group">
                                                                        ...
                                                                        <input type="hidden" class="form-control" name="update" value="<?php echo $tc->id; ?>" autocomplete="off" required="" >
                                                                        <textarea class="ckeditor" name="description" autocomplete="off" required=""><?php echo $tc->description; ?></textarea>
                                                                        @if ($errors->has('description'))
                                                                        <strong class="text-danger">{{ $errors->first('description') }}</strong>                                   
                                                                        @endif
                                                                    </div>                      
