            ...
            <div class="col-xl">
                ...
                <div class="card">
                    ...
                    <?php
                       ...
                       <form method="post" action="{{route('update_developer_details')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <a href="<?php echo route('education_updates_details',['dev_id'=>''.$s->dev_id.'']) ?>" class="btn btn-success form-control">Update</a>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group bmd-form-group is-filled">
                                        ...
                                        <img class="img-fluid img-thumbnail" src="<?php echo URL::asset('public/upload/developer/'.$s->image.'') ?>" style="height:30px;width:40px;">
                                        @if ($errors->has('image'))
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group bmd-form-group is-filled">
                                        ...
                                        <input type="hidden" class="form-control" name="old_resume" value="<?php echo $s->resume; ?>" autocomplete="off" >
                                        <?php echo $s->resume; ?>
