    ...
    <div class="main-wrapper container">   
        <div class="row">
            <div class="col-xl">
                ...
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Add Refund Policy</h5>
                                    ...
                                    foreach($refund_policy as $pp) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger btn-sm" onclick="alert('Are You Sure To Delete This?')" href="<?php echo route('delete_refund',['id'=>''.$pp->id.'']) ?>" ><i class="fa fa-trash"></i></a>
                                            </td>                                                                         
                                        </tr>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Update Refund Policy</h4>
