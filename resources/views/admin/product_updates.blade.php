                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group bmd-form-group">
                                        <label class="bmd-label-floating">Previous Category</label>
                                        <?php
                                            foreach($cat as $c) { 
                                                if($c->id == $p->c_id){

                                        ?>
                                                <input type="text" name="c_id" value="<?php echo $c->name; ?>" class="form-control" placeholder="Category name:" readonly>
                                        <?php } } ?>
                                    </div>                      
                                </div>  
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group bmd-form-group">
                                        <label class="bmd-label-floating">Previous Sub-Category</label>
                                         <?php
                                            foreach($subcategory_details as $s) { 
                                                if($s->id == $p->subcategory_id){

                                        ?>
                                            <input type="text" name="subcategory_id" value="<?php echo $s->name; ?>" class="form-control" placeholder="Sub Category name:" readonly>
                                        <?php } } ?>
                                    </div>                      
                                </div> 
