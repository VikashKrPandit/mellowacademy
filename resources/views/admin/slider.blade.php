	                           ...
	                           <?php $i=1;
                                    foreach($detail as $s) { ?>
                                        <tr>
                                            ...
                                            <td><img class="img-fluid img-thumbnail" src="<?php echo URL::asset('public/upload/banner/'.$s->image.'') ?>" style="height:80px"></td>
                                            <td>
                                                ...
                                                <a class="btn btn-danger btn-sm" onclick="alert('Are You Sure To Delete This?')" href="<?php echo route('delete_banner',['id'=>''.$s->id.'']) ?>" ><i class="fa fa-trash"></i></a>
                                            </td>                                                                         
                                        </tr>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group bmd-form-group is-filled">
                                                                        ...
                                                                        <img class="img-fluid img-thumbnail" src="<?php echo URL::asset('public/upload/banner/'.$s->image.'') ?>" style="height:30px;width:40px;">
                                                                        @if ($errors->has('image'))
    ...
    <div class="main-wrapper container">   
        <div class="row">
            <div class="col-xl">
                ...
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Add Banner Details</h5>
                        <form method="post" action="{{route('submit_banner')}}" enctype="multipart/form-data">
	                        @csrf
	                        <div class="form-row">
