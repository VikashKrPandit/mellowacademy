                                ...
                                foreach($faq_detail as $s) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-sm" onclick="alert('Are You Sure To Delete This?')" href="<?php echo route('delete_faqs',['id'=>''.$s->id.'']) ?>" ><i class="fa fa-trash"></i></a>
                                        </td>                                                                         
                                    </tr>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                    <h4 class="modal-title">All FAQ Details</h4>
