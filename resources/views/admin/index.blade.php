...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Mellow Elements - Admin Dashboard">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <form method="post" action="{{route('login_verification_admin')}}">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" placeholder="Username">
                                            @if ($errors->has('email'))
