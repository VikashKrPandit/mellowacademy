                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="update" value="<?php echo $p->dev_id; ?>" autocomplete="off" required="" >
                                            <input type="text" class="form-control" name="bank_name" value="<?php echo $p->bank_name; ?>" autocomplete="off" required="" >
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="update" value="<?php echo $p->dev_id; ?>" autocomplete="off" required="" >
                                            <input type="text" class="form-control" name="branch_name" value="<?php echo $p->branch_name; ?>" autocomplete="off" required="" >
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="update" value="<?php echo $p->dev_id; ?>" autocomplete="off" required="" >
                                            <input type="text" class="form-control" name="acct_name" value="<?php echo $p->acct_name; ?>" autocomplete="off" required="" >
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="update" value="<?php echo $p->dev_id; ?>" autocomplete="off" required="" >
                                            <input type="text" class="form-control" name="account_number" value="<?php echo $p->account_number; ?>" autocomplete="off" required="" >
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="update" value="<?php echo $p->dev_id; ?>" autocomplete="off" required="" >
                                            <input type="text" class="form-control" name="ifc_code" value="<?php echo $p->ifc_code; ?>" autocomplete="off" required="" >
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="update" value="<?php echo $p->dev_id; ?>" autocomplete="off" required="" >
                                            <input type="text" class="form-control" name="micr_number" value="<?php echo $p->micr_number; ?>" autocomplete="off" required="" >
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group bmd-form-group is-filled">
                                            ...
                                            <input type="hidden" class="form-control" name="old_passbook" value="<?php echo $p->passbook; ?>"  autocomplete="off">
                                            <img class="img-fluid img-thumbnail" src="<?php echo URL::asset('public/upload/passbook/'.$p->passbook.'') ?>" style="height:30px;width:40px;">
