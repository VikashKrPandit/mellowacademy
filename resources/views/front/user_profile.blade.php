                                        ...
                                        <h5 class="card-title">
                                            <div class="text-center text-sm-left mb-2 mb-sm-0 change_img">
                                                ...
                                                @csrf
                                                    ...
                                                    @endif
                                                   <br>
                                                    <button type="submit" class="btn btn-primary"><span>Change Photo</span></button>
                                                </form>
                                            </div>
                                        </h5>
                                        <?php }
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="hidden" class="form-control" name="update" value="<?php echo $user->id; ?>" autocomplete="off" required="" >
                                                            <input type="text" name="fname" value="<?php echo $user->fname; ?>" class="form-control" placeholder="First name: *">
                                                            @if ($errors->has('fname'))
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="hidden" class="form-control" name="update" value="<?php echo $user->id; ?>" autocomplete="off" required="" >
                                                            <input type="text" name="lname" value="<?php echo $user->lname; ?>" class="form-control" placeholder="Last name: *">
                                                            @if ($errors->has('lname'))
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="hidden" class="form-control" name="update" value="<?php echo $user->id; ?>" autocomplete="off" required="" >
                                                            <input type="text" name="user_name" value="<?php echo $user->user_name; ?>" class="form-control" placeholder="User Name:">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="company_name" value="<?php echo $user->company_name; ?>" class="form-control" placeholder="Company Name:">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="hidden" class="form-control" name="update" value="<?php echo $user->id; ?>" autocomplete="off" required="" >
                                                            <input type="tel" name="phone" value="<?php echo $user->phone; ?>" class="form-control" placeholder="Contact No.:" maxlength="10">
                                                            @if ($errors->has('phone'))
                                                    ...
                                                    <div class="col-md-6">
                                                        <button type="submit" class="btn btn-primary"><span>Edit Profile</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
